...
export const positionAnchoredElement = (element: HTMLElement, anchor: HTMLElement, placement: Placement, offsetOptions: OffsetOptions = {}) => {
            ...
            middleware: [
                ...
                size({
                    ...
                    apply: ({
                        ...
                        initialHeight =
                            !isConstrained && !virtualTrigger
                                ? actualHeight
                                : initialHeight || actualHeight;
                        isConstrained =
                            actualHeight < initialHeight ||
                            maxHeight <= actualHeight;
                        const appliedHeight = isConstrained
                            ? `${maxHeight}px`
                            : '';
